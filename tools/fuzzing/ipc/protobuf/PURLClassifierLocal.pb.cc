...
Reply___delete__::~Reply___delete__() {
  // @@protoc_insertion_point(destructor:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<std::string>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Reply___delete__::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  return target;
}

size_t Reply___delete__::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  size_t total_size = 0;
...
void Reply___delete__::MergeFrom(const Reply___delete__& from) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:protobuf.mozilla.dom.PURLClassifierLocal.Reply___delete__)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
