...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PGMPService_5fprotobuf_2emozilla_2egmp_2eh_2eproto;
namespace protobuf {
namespace mozilla {
namespace gmp {
...
class GMPLaunchResult final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.gmp.GMPLaunchResult) */ {
 public:
  ...
  void MergeFrom( const GMPLaunchResult& from) {
    GMPLaunchResult::MergeImpl(*this, from);
  }
  private:
