...
#ifndef GOOGLE_PROTOBUF_INCLUDED_PBackgroundTest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_PBackgroundTest_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_PBackgroundTest_2eproto
...
struct TableStruct_PBackgroundTest_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PBackgroundTest_2eproto;
namespace protobuf {
namespace mozilla {
namespace ipc {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::protobuf::mozilla::ipc::PBackgroundTest::Msg___delete__* Arena::CreateMaybeMessage<::protobuf::mozilla::ipc::PBackgroundTest::Msg___delete__>(Arena*);
template<> ::protobuf::mozilla::ipc::PBackgroundTest::Reply___delete__* Arena::CreateMaybeMessage<::protobuf::mozilla::ipc::PBackgroundTest::Reply___delete__>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protobuf {
namespace mozilla {
namespace ipc {
...
class Msg___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.ipc.PBackgroundTest.Msg___delete__) */ {
 public:
...
class Reply___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:protobuf.mozilla.ipc.PBackgroundTest.Reply___delete__) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:protobuf.mozilla.ipc.PBackgroundTest.Reply___delete__)
 private:
  class _Internal;
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_PBackgroundTest_2eproto
