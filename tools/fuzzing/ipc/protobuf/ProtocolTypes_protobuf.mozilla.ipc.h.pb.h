...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ProtocolTypes_5fprotobuf_2emozilla_2eipc_2eh_2eproto;
namespace protobuf {
namespace mozilla {
namespace ipc {
...
class ProtocolFdMapping final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.ipc.ProtocolFdMapping) */ {
 public:
  ...
  void MergeFrom( const ProtocolFdMapping& from) {
    ProtocolFdMapping::MergeImpl(*this, from);
  }
  private:
