...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PHandlerService_5fprotobuf_2emozilla_2edom_2eh_2eproto;
namespace protobuf {
namespace mozilla {
namespace dom {
class HandlerApp;
...
class HandlerApp final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.dom.HandlerApp) */ {
 public:
  ...
  void MergeFrom( const HandlerApp& from) {
    HandlerApp::MergeImpl(*this, from);
  }
  private:
...
class HandlerInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.dom.HandlerInfo) */ {
 public:
  ...
  void MergeFrom( const HandlerInfo& from) {
    HandlerInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void set_a_extensions(int index, const char* value, size_t size);
  ...
  void add_a_extensions(const char* value, size_t size);
...
void HandlerApp::set_a_detaileddescription(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.a_detaileddescription_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* HandlerApp::release_a_detaileddescription() {
  ...
  return _impl_.a_detaileddescription_.Release();
}
...
inline void HandlerInfo::set_a_extensions(int index, const char* value, size_t size) {
...
inline void HandlerInfo::add_a_extensions(const char* value, size_t size) {
...
inline bool HandlerInfo::_internal_has_a_preferredapplicationhandler() const {
  return this != internal_default_instance() && _impl_.a_preferredapplicationhandler_ != nullptr;
}
