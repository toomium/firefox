...
class Msg___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:protobuf.mozilla.dom.PEndpointForReport.Msg___delete__) */ {
 public:
...
class Reply___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:protobuf.mozilla.dom.PEndpointForReport.Reply___delete__) */ {
 public:
...
void Msg___delete__::set_endpointurl(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.endpointurl_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
