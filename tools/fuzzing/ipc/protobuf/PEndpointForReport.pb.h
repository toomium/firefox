...
#ifndef GOOGLE_PROTOBUF_INCLUDED_PEndpointForReport_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_PEndpointForReport_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_PEndpointForReport_2eproto
...
struct TableStruct_PEndpointForReport_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PEndpointForReport_2eproto;
namespace protobuf {
namespace mozilla {
namespace dom {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::protobuf::mozilla::dom::PEndpointForReport::Msg___delete__* Arena::CreateMaybeMessage<::protobuf::mozilla::dom::PEndpointForReport::Msg___delete__>(Arena*);
template<> ::protobuf::mozilla::dom::PEndpointForReport::Reply___delete__* Arena::CreateMaybeMessage<::protobuf::mozilla::dom::PEndpointForReport::Reply___delete__>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protobuf {
namespace mozilla {
namespace dom {
...
class Msg___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.dom.PEndpointForReport.Msg___delete__) */ {
 public:
...
class Reply___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:protobuf.mozilla.dom.PEndpointForReport.Reply___delete__) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:protobuf.mozilla.dom.PEndpointForReport.Reply___delete__)
 private:
  class _Internal;
...
inline std::string* Msg___delete__::release_a_endpointurl() {
  ...
  return _impl_.a_endpointurl_.Release();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_PEndpointForReport_2eproto
