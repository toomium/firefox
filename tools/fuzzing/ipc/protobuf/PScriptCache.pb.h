...
#ifndef GOOGLE_PROTOBUF_INCLUDED_PScriptCache_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_PScriptCache_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_PScriptCache_2eproto
...
struct TableStruct_PScriptCache_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PScriptCache_2eproto;
namespace protobuf {
namespace mozilla {
namespace loader {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::protobuf::mozilla::loader::PScriptCache::Msg___delete__* Arena::CreateMaybeMessage<::protobuf::mozilla::loader::PScriptCache::Msg___delete__>(Arena*);
template<> ::protobuf::mozilla::loader::PScriptCache::Reply___delete__* Arena::CreateMaybeMessage<::protobuf::mozilla::loader::PScriptCache::Reply___delete__>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protobuf {
namespace mozilla {
namespace loader {
...
class Msg___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla.loader.PScriptCache.Msg___delete__) */ {
 public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_PScriptCache_2eproto;
};
// -------------------------------------------------------------------

class Reply___delete__ final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:protobuf.mozilla.loader.PScriptCache.Reply___delete__) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:protobuf.mozilla.loader.PScriptCache.Reply___delete__)
 private:
  class _Internal;
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_PScriptCache_2eproto
