...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PTestManyHandles_2eproto;
namespace protobuf {
namespace mozilla {
namespace _ipdltest {
...
class Msg_ManyHandles final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.mozilla._ipdltest.PTestManyHandles.Msg_ManyHandles) */ {
 public:
  ...
  void MergeFrom( const Msg_ManyHandles& from) {
    Msg_ManyHandles::MergeImpl(*this, from);
  }
  private:
